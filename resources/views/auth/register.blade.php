...
<head>
    ...
    <title> {{trans('login.register')}}</title>
...
<div class="middle-box text-center loginscreen animated fadeInDown">
    <div>
        ...
        <form class="m-t" action="{{ url('/register') }}" method="post">
            {{ csrf_field() }}
            ...
            <button type="submit" class="btn btn-primary block full-width m-b">{{trans('login.register')}}</button>
