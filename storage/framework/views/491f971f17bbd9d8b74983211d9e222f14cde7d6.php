<div class="modal-header">
    ...
    <?php echo e(Form::model($user, ['route' => ['users.updatemypassword', \Illuminate\Support\Facades\Auth::user()->id], 'method' => 'patch', 'id'=>'formTest'])); ?>
    ...
    <div class="form-body">
        <div class="form-group">
            <div class="form-group"><label>Old Password</label>
                <?php echo e(Form::password('oldpassword',['class'=>'form-control','placeholder'=>'Old Password'])); ?>
